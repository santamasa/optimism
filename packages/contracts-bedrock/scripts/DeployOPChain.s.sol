...
contract DeployOPChainOutput is BaseDeployIO {
    ...
    ISystemConfigV160 internal _systemConfigProxy;
    ...
    function set(bytes4 _sel, address _addr) public virtual {
        ...
        else if (_sel == this.systemConfigProxy.selector) _systemConfigProxy = ISystemConfigV160(_addr) ;
    ...
    function systemConfigProxy() public returns (ISystemConfigV160) {
...
contract DeployOPChain is Script {
    ...
    function assertValidSystemConfig(DeployOPChainInput _doi, DeployOPChainOutput _doo) internal {
        ISystemConfigV160 systemConfig = _doo.systemConfigProxy();
        ...
        require((uint256(0xff) << 248) & systemConfig.scalar() == 0, "SYSCON-70");
